  ...
  <div class="w-full flex flex-col justify-center items-center">
    <div class="w-full flex gap-20">
      ...
      <div class="w-1/4">
        ...
        <p class="text-black text-4 mt-3">Phương thức vận chuyển</p>
      ...
      <div class="w-1/4 ">
        ...
        <div class="flex items-center gap-4">
          ...
          <div>
            <p class="font-bold text-black text-4">0987.654.321</p>
            <p class="text-black text-4">Giải đáp thắc mắc 24/24</p>
          </div>
        </div>
        <p class="font-bold text-black text-6">Kết nối với chúng tôi</p>
        <div class="flex gap-3">
          <img src="/facebook.png" class="w-8 h-8" alt="">
          <img src="/tiktok.png" class="w-8 h-8" alt="">
          <img src="/youtube.png" class="w-8 h-8" alt="">
          <img src="/zalo.png" class="w-8 h-8" alt="">
        </div>
